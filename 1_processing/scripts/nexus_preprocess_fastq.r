...
option_list <- list(
  ...
  make_option(c("-p", "--processors"),
              type="integer",
              default=6,
              help="Number of simultaneous processing threads to utilize"))
...
# opt$file<-'/n/analysis/Zeitlinger/kb2009/MOLNG-3359/HKJHMBGXK/n_1_1_TAGCTT.fastq.gz'
# opt$barcodes<-'CTGA,ACTG,GACT,TGAC'
...
# Restrict FastqStreamer  fthreading
