...
Report generalized summary statistics of openness at these regions.

```{r}
smf_single_all.df$percent_open_published %>% summary()
sd(smf_single_all.df$percent_open_published, na.rm = T)
```
